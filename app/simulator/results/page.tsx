...
function ResultsContent() {
  ...
  if (!input || !result) {
    return (
      <div className="min-h-screen bg-warm-50 px-4 pb-16 pt-12">
        <div className="mx-auto max-w-2xl text-center">
          <AlertTriangle className="mx-auto h-12 w-12 text-coral-500" />
          ...
          <Link
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-teal-600 px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-teal-700"
          >
            シミュレーションをやり直す
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-warm-50 px-4 pb-16 pt-8">
      <div className="mx-auto max-w-3xl">
        <div className="rounded-2xl bg-gradient-to-br from-teal-600 to-teal-700 p-6 text-white shadow-lg sm:p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-teal-200">年間推定受給額</p>
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-sm">
            <span className="rounded-full bg-white/10 px-3 py-1 text-teal-100">
        ...
        <div className="mt-8 rounded-xl border border-border bg-warm-100 p-4">
      ...
      fallback={
        <div className="flex min-h-screen items-center justify-center bg-warm-50">
          <div className="text-center">
            <Calculator className="mx-auto h-8 w-8 animate-pulse text-teal-600" />
