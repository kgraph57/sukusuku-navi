...
export function ResultCard({ eligibleProgram }: ResultCardProps) {
  ...
  const colorClass = CATEGORY_COLOR_MAP[program.category] ?? "bg-gray-50 text-gray-600 border-gray-200"
          ...
          <div className="mt-3 space-y-2">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <Link
                ...
                className="inline-flex items-center gap-1 rounded-lg border border-teal-200 bg-white px-3 py-1.5 text-xs font-medium text-teal-700 transition-colors hover:bg-teal-50"
              >
                詳細を見る
              </Link>
              <a
